...
class InnerSearchResponse:
  ...
  def write(self, oprot):
    ...
    if self.hotels_details is not None:
      ...
      for iter162 in self.hotels_details:
        iter162.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    ...
    if self.promotion_group is not None:
      ...
      for iter163 in self.promotion_group:
        iter163.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    ...
    if self.fast_filter_info is not None:
      ...
      for iter164 in self.fast_filter_info:
        iter164.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    ...
    if self.debug_response is not None:
      ...
      for iter165 in self.debug_response:
        iter165.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.filter_list is not None:
      ...
      for iter166 in self.filter_list:
        iter166.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    ...
    if self.cities_common_conf is not None:
      ...
      for kiter168,viter169 in self.cities_common_conf.items():
...
class NearByInfoRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i174 in xrange(_size170):
            _elem175 = cm.ttypes.NearBySearchInfo()
            _elem175.read(iprot)
            self.nearbyitem_list.append(_elem175)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.nearbyitem_list is not None:
      ...
      for iter176 in self.nearbyitem_list:
        iter176.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i181 in xrange(_size177):
            _elem182 = cm.ttypes.NearBySearchResult()
            _elem182.read(iprot)
...
class PersonalTraitResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i188 in xrange(_size184):
            _elem189 = cm.ttypes.PersonalTraitResult()
            _elem189.read(iprot)
            self.personaltrait_list.append(_elem189)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.personaltrait_list is not None:
      ...
      for iter190 in self.personaltrait_list:
        iter190.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
