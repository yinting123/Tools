...
class ListRequest:
  ...
  thrift_spec = (
    ...
    (8, TType.LIST, 'hotel_price_range', (TType.STRUCT,(cm.ttypes.PriceRange, cm.ttypes.PriceRange.thrift_spec)), None, ), # 8
    ...
    None, # 15
    (16, TType.STRUCT, 'page_info', (cm.ttypes.PageInfo, cm.ttypes.PageInfo.thrift_spec), None, ), # 16
    (17, TType.I32, 'hotel_distance', None, None, ), # 17
    (18, TType.STRING, 'session_id', None, None, ), # 18
    (19, TType.STRUCT, 'user_info', (cm.ttypes.UserInfo, cm.ttypes.UserInfo.thrift_spec), None, ), # 19
    (20, TType.I64, 'filter_ota', None, None, ), # 20
    (21, TType.LIST, 'room_info', (TType.STRUCT,(cm.ttypes.RoomInfo, cm.ttypes.RoomInfo.thrift_spec)), None, ), # 21
  )
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRUCT:
          self.page_info = cm.ttypes.PageInfo()
...
class ListResponse:
  ...
  thrift_spec = (
    ...
    (5, TType.LIST, 'hotel_list', (TType.STRUCT,(cm.ttypes.HotelInfoList, cm.ttypes.HotelInfoList.thrift_spec)), None, ), # 5
    (6, TType.STRUCT, 'hotel_filter', (cm.ttypes.HotelFilter, cm.ttypes.HotelFilter.thrift_spec), None, ), # 6
    (7, TType.STRUCT, 'center_coordinate', (cm.ttypes.GeoInfo, cm.ttypes.GeoInfo.thrift_spec), None, ), # 7
    (8, TType.LIST, 'region_polygon', (TType.STRUCT,(cm.ttypes.GeoInfo, cm.ttypes.GeoInfo.thrift_spec)), None, ), # 8
    (9, TType.STRUCT, 'region_info', (cm.ttypes.RegionInfo, cm.ttypes.RegionInfo.thrift_spec), None, ), # 9
    (10, TType.STRUCT, 'poi_info', (cm.ttypes.POIData, cm.ttypes.POIData.thrift_spec), None, ), # 10
    (11, TType.I32, 'rank_type', None, None, ), # 11
    (12, TType.I32, 'poi_lang', None, None, ), # 12
    (13, TType.STRUCT, 'status', (cm.ttypes.ServerStatus, cm.ttypes.ServerStatus.thrift_spec), None, ), # 13
  )
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i46 in xrange(_size42):
            _elem47 = cm.ttypes.HotelInfoList()
            _elem47.read(iprot)
        ...
        if ftype == TType.STRUCT:
          self.hotel_filter = cm.ttypes.HotelFilter()
          self.hotel_filter.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 7:
        if ftype == TType.STRUCT:
          self.center_coordinate = cm.ttypes.GeoInfo()
        ...
        if ftype == TType.STRUCT:
          self.region_info = cm.ttypes.RegionInfo()
          self.region_info.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 10:
        if ftype == TType.STRUCT:
          self.poi_info = cm.ttypes.POIData()
...
class ListMapResponse:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I64, 'search_id', None, None, ), # 1
    (2, TType.LIST, 'hotel_info', (TType.STRUCT,(cm.ttypes.HotelInfoMap, cm.ttypes.HotelInfoMap.thrift_spec)), None, ), # 2
    None, # 3
    None, # 4
    None, # 5
    None, # 6
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i60 in xrange(_size56):
            _elem61 = cm.ttypes.HotelInfoMap()
            _elem61.read(iprot)
...
class ListRtsRequest:
  ...
  thrift_spec = (
    ...
    None, # 8
    (9, TType.STRUCT, 'user_info', (cm.ttypes.UserInfo, cm.ttypes.UserInfo.thrift_spec), None, ), # 9
...
class ListRtsResponse:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I64, 'search_id', None, None, ), # 1
    (2, TType.LIST, 'hotel_rts_info', (TType.STRUCT,(cm.ttypes.HotelRtsInfo, cm.ttypes.HotelRtsInfo.thrift_spec)), None, ), # 2
    None, # 3
    None, # 4
    None, # 5
    None, # 6
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i74 in xrange(_size70):
            _elem75 = cm.ttypes.HotelRtsInfo()
            _elem75.read(iprot)
...
class DetailResponse:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I64, 'search_id', None, None, ), # 1
    (2, TType.STRUCT, 'hotel_info', (cm.ttypes.HotelInfoDetail, cm.ttypes.HotelInfoDetail.thrift_spec), None, ), # 2
    (3, TType.LIST, 'provider_detail', (TType.STRUCT,(cm.ttypes.ProviderDetail, cm.ttypes.ProviderDetail.thrift_spec)), None, ), # 3
    (4, TType.STRUCT, 'region_info', (cm.ttypes.RegionInfo, cm.ttypes.RegionInfo.thrift_spec), None, ), # 4
    None, # 5
    None, # 6
    None, # 7
    None, # 8
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRUCT:
          self.hotel_info = cm.ttypes.HotelInfoDetail()
        ...
        if ftype == TType.LIST:
          ...
          for _i81 in xrange(_size77):
            _elem82 = cm.ttypes.ProviderDetail()
            _elem82.read(iprot)
...
class HotHotelResponse:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I64, 'search_id', None, None, ), # 1
    (2, TType.LIST, 'hot_hotel', (TType.STRUCT,(cm.ttypes.HotHotelInfo, cm.ttypes.HotHotelInfo.thrift_spec)), None, ), # 2
    None, # 3
    None, # 4
    None, # 5
    None, # 6
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i88 in xrange(_size84):
            _elem89 = cm.ttypes.HotHotelInfo()
            _elem89.read(iprot)
...
class DetailRtsResponse:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I64, 'search_id', None, None, ), # 1
    (2, TType.LIST, 'provider_detail', (TType.STRUCT,(cm.ttypes.ProviderDetailInc, cm.ttypes.ProviderDetailInc.thrift_spec)), None, ), # 2
    None, # 3
    None, # 4
    None, # 5
    None, # 6
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i102 in xrange(_size98):
            _elem103 = cm.ttypes.ProviderDetailInc()
            _elem103.read(iprot)
...
class NearbyResponse:
  ...
  thrift_spec = (
    ...
    (4, TType.LIST, 'poi', (TType.STRUCT,(cm.ttypes.NearbyPOI, cm.ttypes.NearbyPOI.thrift_spec)), None, ), # 4
    None, # 5
    None, # 6
    None, # 7
    None, # 8
...
class InnerSearchRequest:
  ...
  thrift_spec = (
    ...
    (2, TType.STRUCT, 'hotel_attr', (cm.ttypes.HotelAttribute, cm.ttypes.HotelAttribute.thrift_spec), None, ), # 2
    (3, TType.STRUCT, 'room_attr', (cm.ttypes.RoomAttribute, cm.ttypes.RoomAttribute.thrift_spec), None, ), # 3
    (4, TType.STRUCT, 'product_attr', (cm.ttypes.ProductAttribute, cm.ttypes.ProductAttribute.thrift_spec), None, ), # 4
    (5, TType.STRUCT, 'geo_attr', (cm.ttypes.GeoAttribute, cm.ttypes.GeoAttribute.thrift_spec), None, ), # 5
    (6, TType.STRUCT, 'customer_attr', (cm.ttypes.CustomerAttribute, cm.ttypes.CustomerAttribute.thrift_spec), None, ), # 6
    (7, TType.STRUCT, 'page_rank_attr', (cm.ttypes.PageRankAttribute, cm.ttypes.PageRankAttribute.thrift_spec), None, ), # 7
    (8, TType.STRUCT, 'caller_attr', (cm.ttypes.CallerAttribute, cm.ttypes.CallerAttribute.thrift_spec), None, ), # 8
    (9, TType.STRUCT, 'return_attr', (cm.ttypes.ReturnAttribute, cm.ttypes.ReturnAttribute.thrift_spec), None, ), # 9
    (10, TType.STRUCT, 'user_info', (cm.ttypes.UserInfo, cm.ttypes.UserInfo.thrift_spec), None, ), # 10
    (11, TType.STRUCT, 'filter_attr', (cm.ttypes.FilterAttribute, cm.ttypes.FilterAttribute.thrift_spec), None, ), # 11
    (12, TType.STRUCT, 'rec_attr', (cm.ttypes.RecommendAttribute, cm.ttypes.RecommendAttribute.thrift_spec), None, ), # 12
    (13, TType.STRUCT, 'fastfilter_attr', (cm.ttypes.FastFilterAttribute, cm.ttypes.FastFilterAttribute.thrift_spec), None, ), # 13
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRUCT:
          self.hotel_attr = cm.ttypes.HotelAttribute()
          self.hotel_attr.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.STRUCT:
          self.room_attr = cm.ttypes.RoomAttribute()
          self.room_attr.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.STRUCT:
          self.product_attr = cm.ttypes.ProductAttribute()
          self.product_attr.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.STRUCT:
          self.geo_attr = cm.ttypes.GeoAttribute()
          self.geo_attr.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 6:
        if ftype == TType.STRUCT:
          self.customer_attr = cm.ttypes.CustomerAttribute()
          self.customer_attr.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 7:
        if ftype == TType.STRUCT:
          self.page_rank_attr = cm.ttypes.PageRankAttribute()
          self.page_rank_attr.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 8:
        if ftype == TType.STRUCT:
          self.caller_attr = cm.ttypes.CallerAttribute()
          self.caller_attr.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 9:
        if ftype == TType.STRUCT:
          self.return_attr = cm.ttypes.ReturnAttribute()
        ...
        if ftype == TType.STRUCT:
          self.filter_attr = cm.ttypes.FilterAttribute()
          self.filter_attr.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 12:
        if ftype == TType.STRUCT:
          self.rec_attr = cm.ttypes.RecommendAttribute()
          self.rec_attr.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 13:
        if ftype == TType.STRUCT:
          self.fastfilter_attr = cm.ttypes.FastFilterAttribute()
...
class InnerSearchResponse:
  ...
  thrift_spec = (
    ...
    (6, TType.LIST, 'hotels_details', (TType.STRUCT,(cm.ttypes.HotelDetail, cm.ttypes.HotelDetail.thrift_spec)), None, ), # 6
    (7, TType.STRUCT, 'statistics', (cm.ttypes.Statistics, cm.ttypes.Statistics.thrift_spec), None, ), # 7
    (8, TType.STRUCT, 'query_parse_result', (cm.ttypes.QueryParseResult, cm.ttypes.QueryParseResult.thrift_spec), None, ), # 8
    (9, TType.I32, 'min_weifang_price', None, None, ), # 9
    (10, TType.LIST, 'promotion_group', (TType.STRUCT,(cm.ttypes.PromotionGroup, cm.ttypes.PromotionGroup.thrift_spec)), None, ), # 10
    None, # 11
    (12, TType.STRUCT, 'filter_result', (cm.ttypes.FilterResult, cm.ttypes.FilterResult.thrift_spec), None, ), # 12
    ...
    (22, TType.LIST, 'debug_response', (TType.STRUCT,(cm.ttypes.DebugResponse, cm.ttypes.DebugResponse.thrift_spec)), None, ), # 22
    (23, TType.LIST, 'filter_list', (TType.STRUCT,(cm.ttypes.FilterList, cm.ttypes.FilterList.thrift_spec)), None, ), # 23
    (24, TType.STRUCT, 'rec_response', (cm.ttypes.Recommend, cm.ttypes.Recommend.thrift_spec), None, ), # 24
    (25, TType.STRUCT, 'common_conf', (cm.ttypes.CommonConf, cm.ttypes.CommonConf.thrift_spec), None, ), # 25
    (26, TType.STRUCT, 'user_track', (cm.ttypes.UserTrack, cm.ttypes.UserTrack.thrift_spec), None, ), # 26
    (27, TType.I32, 'grandson', None, None, ), # 27
    (28, TType.LIST, 'discounts', (TType.DOUBLE,None), None, ), # 28
    (29, TType.BOOL, 'use_new_recall_reason', None, None, ), # 29
    (30, TType.MAP, 'cities_common_conf', (TType.I32,None,TType.STRUCT,(cm.ttypes.CommonConf, cm.ttypes.CommonConf.thrift_spec)), None, ), # 30
    None, # 31
    (32, TType.LIST, 'price_range_statistic', (TType.STRUCT,(cm.ttypes.PriceRangeStatistic, cm.ttypes.PriceRangeStatistic.thrift_spec)), None, ), # 32
  )

  def __init__(self, status=None, total=None, count=None, page_size=None, page_index=None, hotels_details=None, statistics=None, query_parse_result=None, min_weifang_price=None, promotion_group=None, debug_info=None, filter_result=None, fast_filter_info=None, debug_response=None, filter_list=None, rec_response=None, common_conf=None, user_track=None, grandson=None, discounts=None, use_new_recall_reason=None, cities_common_conf=None, price_range_statistic=None,):
    self.status = status
    self.total = total
    self.count = count
    ...
    self.use_new_recall_reason = use_new_recall_reason
    self.cities_common_conf = cities_common_conf
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i123 in xrange(_size119):
            _elem124 = cm.ttypes.HotelDetail()
            _elem124.read(iprot)
        ...
        if ftype == TType.STRUCT:
          self.query_parse_result = cm.ttypes.QueryParseResult()
        ...
        if ftype == TType.LIST:
          ...
          for _i129 in xrange(_size125):
            _elem130 = cm.ttypes.PromotionGroup()
            _elem130.read(iprot)
        ...
        if ftype == TType.LIST:
          ...
          for _i141 in xrange(_size137):
            _elem142 = cm.ttypes.DebugResponse()
            _elem142.read(iprot)
        ...
        if ftype == TType.STRUCT:
          self.rec_response = cm.ttypes.Recommend()
          self.rec_response.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 25:
        if ftype == TType.STRUCT:
          self.common_conf = cm.ttypes.CommonConf()
          self.common_conf.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 26:
        if ftype == TType.STRUCT:
          self.user_track = cm.ttypes.UserTrack()
        ...
        if ftype == TType.BOOL:
          self.use_new_recall_reason = iprot.readBool()
        else:
          iprot.skip(ftype)
      elif fid == 30:
        if ftype == TType.MAP:
          self.cities_common_conf = {}
          (_ktype156, _vtype157, _size155 ) = iprot.readMapBegin()
          for _i159 in xrange(_size155):
            _key160 = iprot.readI32()
            _val161 = cm.ttypes.CommonConf()
            _val161.read(iprot)
            self.cities_common_conf[_key160] = _val161
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 32:
        if ftype == TType.LIST:
          ...
          for _i166 in xrange(_size162):
            _elem167 = cm.ttypes.PriceRangeStatistic()
            _elem167.read(iprot)
            self.price_range_statistic.append(_elem167)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.hotels_details is not None:
      ...
      for iter168 in self.hotels_details:
        iter168.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    ...
    if self.promotion_group is not None:
      ...
      for iter169 in self.promotion_group:
        iter169.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    ...
    if self.fast_filter_info is not None:
      ...
      for iter170 in self.fast_filter_info:
        iter170.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    ...
    if self.debug_response is not None:
      ...
      for iter171 in self.debug_response:
        iter171.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.filter_list is not None:
      ...
      for iter172 in self.filter_list:
        iter172.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    ...
    if self.discounts is not None:
      ...
      for iter173 in self.discounts:
        oprot.writeDouble(iter173)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.use_new_recall_reason is not None:
      oprot.writeFieldBegin('use_new_recall_reason', TType.BOOL, 29)
      oprot.writeBool(self.use_new_recall_reason)
      oprot.writeFieldEnd()
    if self.cities_common_conf is not None:
      oprot.writeFieldBegin('cities_common_conf', TType.MAP, 30)
      oprot.writeMapBegin(TType.I32, TType.STRUCT, len(self.cities_common_conf))
      for kiter174,viter175 in self.cities_common_conf.items():
        oprot.writeI32(kiter174)
        viter175.write(oprot)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.price_range_statistic is not None:
      oprot.writeFieldBegin('price_range_statistic', TType.LIST, 32)
      oprot.writeListBegin(TType.STRUCT, len(self.price_range_statistic))
      for iter176 in self.price_range_statistic:
        iter176.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.use_new_recall_reason)
    value = (value * 31) ^ hash(self.cities_common_conf)
...
class FilterSearchRequest:
  ...
  thrift_spec = (
    ...
    (2, TType.STRUCT, 'geo_attr', (cm.ttypes.GeoAttribute, cm.ttypes.GeoAttribute.thrift_spec), None, ), # 2
    (3, TType.STRUCT, 'caller_attr', (cm.ttypes.CallerAttribute, cm.ttypes.CallerAttribute.thrift_spec), None, ), # 3
    (4, TType.STRUCT, 'filter_attr', (cm.ttypes.FilterAttribute, cm.ttypes.FilterAttribute.thrift_spec), None, ), # 4
    (5, TType.STRUCT, 'user_info', (cm.ttypes.UserInfo, cm.ttypes.UserInfo.thrift_spec), None, ), # 5
  )
...
class FilterSearchResponse:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'status', (cm.ttypes.ServerStatus, cm.ttypes.ServerStatus.thrift_spec), None, ), # 1
    (2, TType.STRUCT, 'filter_result', (cm.ttypes.FilterResult, cm.ttypes.FilterResult.thrift_spec), None, ), # 2
  )
...
class NearByInfoRequest:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'nearbyitem_list', (TType.STRUCT,(cm.ttypes.NearBySearchInfo, cm.ttypes.NearBySearchInfo.thrift_spec)), None, ), # 1
  )
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i181 in xrange(_size177):
            _elem182 = cm.ttypes.NearBySearchInfo()
            _elem182.read(iprot)
            self.nearbyitem_list.append(_elem182)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.nearbyitem_list is not None:
      ...
      for iter183 in self.nearbyitem_list:
        iter183.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class NearByInfoResponse:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'nearbyitem_list', (TType.STRUCT,(cm.ttypes.NearBySearchResult, cm.ttypes.NearBySearchResult.thrift_spec)), None, ), # 1
  )
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i188 in xrange(_size184):
            _elem189 = cm.ttypes.NearBySearchResult()
            _elem189.read(iprot)
            self.nearbyitem_list.append(_elem189)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.nearbyitem_list is not None:
      oprot.writeFieldBegin('nearbyitem_list', TType.LIST, 1)
      oprot.writeListBegin(TType.STRUCT, len(self.nearbyitem_list))
      for iter190 in self.nearbyitem_list:
        iter190.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class PersonalTraitRequest:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'personal_info', (cm.ttypes.PersonalInfo, cm.ttypes.PersonalInfo.thrift_spec), None, ), # 1
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.personal_info = cm.ttypes.PersonalInfo()
...
class PersonalTraitResponse:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'personaltrait_list', (TType.STRUCT,(cm.ttypes.PersonalTraitResult, cm.ttypes.PersonalTraitResult.thrift_spec)), None, ), # 1
  )
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i195 in xrange(_size191):
            _elem196 = cm.ttypes.PersonalTraitResult()
            _elem196.read(iprot)
            self.personaltrait_list.append(_elem196)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.personaltrait_list is not None:
      ...
      for iter197 in self.personaltrait_list:
        iter197.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
